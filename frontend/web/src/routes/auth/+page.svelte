...
<div class="auth-container">
  <div class="auth-card">
    ...
    <div class="auth-footer">
      {#if isLogin}
        <p>Don't have an account? <button class="link-button" on:click={toggleForm}>Register</button></p>
      {:else}
        <p>Already have an account? <button class="link-button" on:click={toggleForm}>Login</button></p>
      {/if}
    </div>
